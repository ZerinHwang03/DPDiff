...
def compose_context(h_protein, h_ligand, h_protein_uncond, h_ligand_uncond, pos_protein, pos_ligand, batch_protein,
                    batch_ligand, hbap_protein=None, hbap_ligand=None):
    ...
    h_ctx_uncond = torch.cat([h_protein_uncond, h_ligand_uncond], dim=0)[sort_idx]  # (N_protein+N_ligand, H)
    ...
    return h_ctx, h_ctx_uncond, pos_ctx, batch_ctx, mask_ligand, hbap_ctx
