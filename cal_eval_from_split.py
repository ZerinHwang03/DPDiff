...
if __name__ == '__main__':
    eval_path = '/home/huangzl/Data/workspace/self-gen/SG-Self-IRDiff_db128_n1r1_sconly_nb_gsbapv3-n05-bit_rb-ipdiff_chunkcfg-scale075/eval_results/'
    results_fn_list = glob(os.path.join(eval_path, 'metrics_*.pt'))
    print("num of results.pt: ",  len(results_fn_list))
    docking_mode = 'vina_dock' # vina_score
...
#     print("sa_all_mean, sa_all_median:", sa_all_mean, sa_all_median)
    ...
    if len(qvina_all):
        ...
        print("QVina:   Mean: %.3f Median: %.3f", qvina_all_mean, qvina_all_median)
